    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            try:
                ...
                # payload size limit (~4KB total). We use the Bot API maximum
                # because this Jane instance previously registered 100 commands
                # successfully; /commands remains the fallback for overflow.
